...
import android.database.sqlite.SQLiteOpenHelper;
    ...
    public class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("create table Classes (user varchar(50), name varchar(25), instructor varchar(25), deptID varchar(25), number varchar(25), section varchar(25), meetingTime varchar(25), location varchar(25), lat varchar(25), lon varchar(25), leaveTime integer, tripsTaken integer)");
        }
